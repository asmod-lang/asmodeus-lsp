...
pub fn create_word_location(uri: &Url, line_num: usize, start_pos: usize, word_len: usize) -> Location {
    Location {
        uri: uri.clone(),
        range: Range {
            start: Position {
...
pub fn coordinates_to_location(uri: &Url, line_num: usize, start_pos: usize, end_pos: usize) -> Location {
    Location {
        uri: uri.clone(),
        range: Range {
            start: Position {
...
pub fn create_parser_diagnostic(message: String, error_type: &str) -> Diagnostic {
    Diagnostic {
        ...
        code: Some(NumberOrString::String(error_type.to_string())),
        source: Some("asmodeus-lsp".to_string()),
        message,
        related_information: None,
        tags: None,
